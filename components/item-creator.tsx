    ...
    >
      <DialogTrigger asChild>
        <Button
          variant="secondary"
          size="sm"
          className="text-xs text-muted-foreground text-sky-500"
        >
      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="mb-2 text-center">Create a new Item</DialogTitle>
        </DialogHeader>
        <div>
          <Form {...form}>
                            ...
                            {acceptedFiles && acceptedFiles[0] && (
                              <div className="max-w-xs flex items-center rounded-md overflow-hidden outline outline-[1px] divide-x">
                                <div className="px-3 py-2 h-full grid place-items-center">
                                  <BsFiletypePpt className="h-4 w-4 text-red-500" />
                                </div>
